...
@section('content')
    ...
    <section>
        <div class="container">
            ...
            <div class="mt-5">
                <h3 class="text-dark display-6">Programming Division</h3>
            </div>
            <div class="row g-0">
                ...
                <div class="mt-5">
                    <h3 class="text-dark display-6 text-center">Graphics Designing Division</h3>
                </div>
                ...
                <div class="mt-5">
                    <h3 class="text-dark display-6 align-items-right">Networking</h3>
                </div>
                ...
                <div class="mt-5">
                    <h3 class="text-dark display-6 text-center d-block">Web Development</h3>
                </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 p-4 shadow-lg">
                    <p align="justify" class="mt-5 lh-lg" style="letter-spacing: 1px;">
                        ...
                        <a href="{{ route('web.department') }}" class="text-decoration-none text-primary">More</a>
                    </p>
                </div>
                ...
                <div class="mt-5">
                    <h3 class="text-dark display-6 mx-5">Computer Maintenance</h3>
                </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 p-4 shadow-lg">
                    <p align="justify" style="letter-spacing: 1px; line-height: 30px;">
                        ...
                        <a href="{{ route('maintenance.department') }}" class="text-decoration-none text-primary">More</a>
                    </p>
                </div>

                <div class="mt-5">
                    <h3 class="text-dark display-6 text-center mx-5">Cyber Security</h3>
                </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 p-4 shadow-lg">
                    <p align="justify" class="lh-lg" style="letter-spacing: 1px;">
                        ...
                        <a href="{{ route('cyber.department') }}" class="text-decoration-none text-primary">More</a>
                    </p>
                </div>
