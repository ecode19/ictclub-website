...
<body>
            ...
            <div class="container">
                ...
                @if (!Auth::user()->profile_picture)
                    <div class="alert alert-warning text-center" role="alert">
                        Hi, <strong>{{ Auth::user()->fullname }}</strong> Click On Profile Update to Change Your Profile Picture. </a>
                    </div>
                @endif
                <div class="row">
                    <div class="col-12 col-md-10 col-lg-6">
                        <div class="card shadow-lg">
                            ...
                            <button type="submit" name="update" class="btn color fs-5"><a
                                    href="{{ route('profileUpdate', ['id' => $userInfo->id]) }}" class="text-white text-decoration-none">Update
                                    Profile</a></button>
                        </div>
                    </div>
        ...
        <div class="alert alert-warning" role="alert">
            <p> <strong> NOTE: </strong> For Any Missing or incorrect information please Contact, <strong>Mr: Mwauyemba </strong></p>
        </div>
        </div>
