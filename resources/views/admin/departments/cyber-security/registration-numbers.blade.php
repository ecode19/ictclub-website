...
<div class="container mt-5 ">
    <div  class="alert alert-secondary" role="alert">
        <h6>You have total of <strong class="fs-5">{{ $totalCyberSecurityMembers }}</strong>  registered members under cyber security department</h6>
    </div>
    <form action="{{ route('store') }}" method="POST" class="container my-5">
        ...
        <div id="registration-numbers">
            <div class="row mb-3 registration-number-field">
                <div class="col-md-10">
                    <input type="text" name="registration_numbers[]" placeholder="Registration Number" required
                        class="form-control">
                </div>
                <div class="col-md-2">
