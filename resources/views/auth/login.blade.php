                ...
                <form action="{{ route('login') }}" method="post" autocomplete="off">
                    ...
                    <div class="form-outline mt-4 col-lg-9" data-aos="zoom-in-right">
                        ...
                        <input type="text" name="registration_number"
                               placeholder="Enter valid Registration number" class="form-control @error('registration_number') is-invalid @enderror">
                        <div>
                    ...
                    <div class="col-md py-3" data-aos="fade-up" data-aos-duration="2000">
                        <p>Or Sign in with</p>
                        <a href="https://www.facebook.com/YourFacebookURLHere" target="_blank"
